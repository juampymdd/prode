  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/80 text-primary-foreground">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center px-4 py-16 text-center md:py-24">
        <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-[0.2em] [text-shadow:0_1px_4px_rgba(10,15,40,0.5)]">
          Mundial 2026
        </p>
        <h1 className="text-balance text-4xl font-extrabold leading-tight tracking-tight [text-shadow:0_2px_12px_rgba(10,15,40,0.55)] sm:text-5xl md:text-6xl">
          El prode del Mundial 2026
        </h1>
        <p className="mt-4 max-w-xl text-balance text-base text-white/95 [text-shadow:0_1px_6px_rgba(10,15,40,0.7)] sm:text-lg">
