...
insert into public.teams (name, code, flag_url) values
  ...
  ('Czech Republic',         'CZE', 'https://flagcdn.com/cz.svg'),
  ('Canada',                 'CAN', 'https://flagcdn.com/ca.svg'),
  ('Bosnia & Herzegovina',   'BIH', 'https://flagcdn.com/ba.svg'),
  ...
  ('Scotland',               'SCO', 'https://flagcdn.com/gb-sct.svg'),
  ...
  ('Curaçao',                'CUW', 'https://flagcdn.com/cw.svg'),
  ...
  ('Cape Verde',             'CPV', 'https://flagcdn.com/cv.svg'),
  ...
  ('Iraq',                   'IRQ', 'https://flagcdn.com/iq.svg'),
  ...
  ('DR Congo',               'COD', 'https://flagcdn.com/cd.svg'),
